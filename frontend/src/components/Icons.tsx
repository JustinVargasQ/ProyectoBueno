...
// Ahora 'iconMap' tiene acceso a todos los iconos de @mui/icons-material
export const iconMap: { [key: string]: typeof SvgIconComponent } = {
  ...(MuiIcons as { [key: string]: typeof SvgIconComponent }), // Expande todos los iconos importados
  'default': MuiIcons.Storefront, // Mantiene un ícono por defecto
};

// --- CORRECCIÓN: Exportamos los iconos individualmente ---
// Esto permite que otros archivos los importen de forma segura sin errores de TypeScript
